...
import { getNumerologyReportById } from 'apiSdk/numerology-reports';
...
function NumerologyReportViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Numerology Report Detail View
          </Text>
          {hasAccess('numerology_report', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/numerology-reports/edit/${data?.id}`} passHref legacyBehavior>
              <Button
